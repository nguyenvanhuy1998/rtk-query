...
// Đầu tiên chúng ta sẽ khai báo một function check kiểm tra cấu trúc về mặt login javascript
...
// So sánh với phương pháp ép kiểu `Type Assertions` thì ép kiểu chúng giúp chúng ta đúng về mặt Type,
// chưa chắc về logic
